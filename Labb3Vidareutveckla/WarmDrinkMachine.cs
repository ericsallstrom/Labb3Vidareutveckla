...
namespace Labb3Vidareutveckla
{
    ...
    internal class WarmDrinkMachine
    {
        ...
        public WarmDrinkMachine()
        {
            ...
            RegisterFactory<CoffeeFactory>("Coffee"); // Registerar fabriken för kaffe.
            RegisterFactory<CappuccinoFactory>("Cappuccino"); // Registerar fabriken för cappuccino.
            RegisterFactory<HotChocolateFactory>("Hot Chocolate"); // Registerar fabriken för varm choklad.
        }
        ...
        public IWarmDrink MakeDrink()
        {
            ...
            for (var i = 0; i < namedFactories.Count; i++)
            {
                var tuple = namedFactories[i];
                Console.WriteLine($"{i}: {tuple.Item1}"); // Skriver ut tillgängliga drycker.
            }
